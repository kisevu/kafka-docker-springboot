package com.ameda.kevin.consumer.config;
...
@EnableKafka //detect kafka listeners
@Configuration
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<UUID, TransactionMessage> consumerFactory(){
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE,"com.ameda.kevin.consumer.model.TransactionMessage");
